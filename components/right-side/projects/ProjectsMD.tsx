...
const ProjectsMD = () => {
  ...
  return (
    <div className="hidden md:flex flex-col justify-start items-center gap-8">
      ...
      <div className="h-full w-full max-w-7xl flex gap-8 lg:gap-12 transition-all duration-500">
        {projects
                      ...
                      {project.stack.map((tech, stackIndex) => {
                        return (
                          <div
                            key={stackIndex}
                            className={
                              "p-1 bg-white bg-opacity-20 rounded-lg hidden group-hover:flex items-center justify-center"
                            }
                          >
                            <Image
                              width={20}
